...
'password' => '4aJu6Cwh4cPKQUuW',
 Instructor's sample in Github 網址
 資訊與科技期中網頁互評 網址
 王霆瑄學長的Github 網址
 FitnessFactory FrontEnd 檔案
 FitnessFactory_FrontEnd(LOCAL HOST) 網址http://localhost/FitnessFactory_FrontEnd/
 webvote2017 檔案
 webvote2017(localhost) 網址http://localhost/webvote2017/login.php
##Github
